...
$(document).click(function() {  /*para que si se da clic fuera de la alerta nos direccione a la pagina del formulario */
	location.href ='<?php echo $dir ?>';
});

/* document es para que cuando se presione la tecla scape nos direccione a la pagina direccion*/
